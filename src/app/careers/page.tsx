...
export default function CareersPage() {
  ...
  return (
    <div className={styles.page}>
      ...
      <section className="openingsSection">
        <div className="container">
          ...
          <div className="openingsGrid">
            {positions.map((position, index) => (
              <div key={index} className="openingCard">
                <div className="positionNumber">{String(index + 1).padStart(2, '0')}</div>
                <div className="positionContent">
                  <h3 className="positionTitle">{position.title}</h3>
                  <div className="positionMeta">
                    <div className="metaItem">
                      <span className="metaLabel">Experience</span>
                      <span className="metaValue">5-8 Years</span>
                    </div>
                    <div className="metaItem">
                      <span className="metaLabel">Location</span>
                      <span className="metaValue">{position.location}</span>
                    </div>
                    <div className="metaItem">
                      <span className="metaLabel">Type</span>
                      <span className="metaValue">{position.type}</span>
                    </div>
                  </div>
        ...
        <div className="container">
          <div className={styles.grid}>
            <div className={styles.formSection}>
              <h2 className="formHeading mt-100">Start Your Application</h2>
              <form className="form">
